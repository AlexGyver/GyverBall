...
# Bluetooth лабиринт на Arduino своими руками
...
<a id="chapter-0"></a>
## Описание проекта
Классический инерционный лабиринт с шариком
Особенности:
- Управление со смартфона по Bluetooth
- Таймер прохождения карты
- Настройка чувствительности и калибровка уровня
<a id="chapter-1"></a>
## Папки
...
<a id="chapter-2"></a>
## Схемы
![SCHEME](https://github.com/AlexGyver/GyverBall/blob/master/schemes/scheme1.jpg)
![SCHEME](https://github.com/AlexGyver/GyverBall/blob/master/schemes/scheme2.jpg)
...
- Серво маленькая http://ali.pub/2u6fi7 http://ali.pub/2u6fgn
- Серво большая http://ali.pub/2u6few http://ali.pub/2u6ffv
